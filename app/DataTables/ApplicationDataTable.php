...
class ApplicationDataTable extends DataTable
{
    ...
    {
        return [
            'name' => (new Column(['title' => __('models/application.fields.name'), 'data' => 'name','searchable' => false]))
,
            'description' => (new Column(['title' => __('models/application.fields.description'), 'data' => 'description','searchable' => false]))
